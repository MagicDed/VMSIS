// Матрица с динамическим массивом в которой нужно отсортировать числа по убыванию в столбце, но оставлять положительные числа на своих местах (через функции)

#include "Header.h"
#include "FunctionList5.5.c"
